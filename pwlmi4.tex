...
\begin{frame}
    \textit{With a bit of abuse of notation}, let us denote the result 
    of a program \P evaluated over an input \D with $\P(\D)$. 
...
\begin{frame}
    \begin{itemize}
        \item Recall: An interpreter is a \textit{program}
        \item This \emph{program} takes another \textit{program} as input
        \item and the input data
        \item evaluates the program on the input and returns the result
    \end{itemize}
\end{frame}
