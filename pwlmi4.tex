...
\begin{frame}{Partial Evaluation of \only<1>{an Interpreter}\only<2->{the Partial Evaluation of an Interpreter}}
...
\begin{frame}{\only<2->{Partial Evaluation of the} Partial Evaluation of the Partial Evaluation of an Interpreter}
